...
CUDA_VISIBLE_DEVICES=5 python3 ~/code/c2d/main_cifar.py --r 0.8 --lambda_u 25 \
--dataset cifar10 --p_threshold 0.03 --data_path cifar-10/cifar-10-batches-py/  --experiment-name simclr_resnet18 \
 ...
 --log_wandb=True --wandb_project='C2D_extend' --wandb_experiment='C2D_baseline_clean_1000_l2b_cifar10_noise80'