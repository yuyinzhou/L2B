...
def run_test(epoch, net1, net2, test_loader, device, test_log, log_wandb=False):
    net1.eval()
    net2.eval()
    correct = 0
    total = 0
...
def run_train_loop(net1, optimizer1, sched1, net2, optimizer2, sched2, criterion, CEloss, CE, loader, p_threshold,
                   ...
                   dataset, r, conf_penalty, stats_log, loss_log, test_log, args, metadata=None):
    ...
    for epoch in range(num_epochs + 1):
        ...
        if epoch < warm_up:
            ...
            train(epoch, net1, net2, criterion, optimizer1, labeled_trainloader, unlabeled_trainloader, lambda_u,
                  batch_size, num_class, device, T, alpha, warm_up, dataset, r, noise_mode, num_epochs, metadata=metadata, args=args)  # train net1
            ...
            train(epoch, net2, net1, criterion, optimizer2, labeled_trainloader, unlabeled_trainloader, lambda_u,
                  batch_size, num_class, device, T, alpha, warm_up, dataset, r, noise_mode, num_epochs, metadata=None, args=args)  # train net2
        run_test(epoch, net1, net2, test_loader, device, test_log, log_wandb=args.log_wandb)
